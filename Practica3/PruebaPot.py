...
class PruebaPot(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PruebaPot")
        ...
        # Blocks
        ##################################################
        self._vamp_range = Range(0, 100, 1, 1, 200)
        self._vamp_win = RangeWidget(self._vamp_range, self.set_vamp, 'Vamp', "counter_slider", float)
        self.top_layout.addWidget(self._vamp_win)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 1000, vamp, 0, 0)
    ...
    def set_vamp(self, vamp):
        self.vamp = vamp
        self.analog_sig_source_x_0.set_amplitude(self.vamp)
...
def main(top_block_cls=PruebaPot, options=None):
