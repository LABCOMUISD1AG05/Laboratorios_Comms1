...
class moduladorpwm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._Offset_range = Range(-2, 4, 10e-3, -1, 200)
        self._Offset_win = RangeWidget(self._Offset_range, self.set_Offset, "Offset SawTooth", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._Offset_win)
        self._A_range = Range(-2, 4, 10e-3, 2, 200)
        self._A_win = RangeWidget(self._A_range, self.set_A, "Amplitud Saw Tooth", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 10000, A, Offset-A, 0)
    ...
    def set_Offset(self, Offset):
        self.Offset = Offset
        self.analog_sig_source_x_0_0.set_offset(self.Offset-self.A)
