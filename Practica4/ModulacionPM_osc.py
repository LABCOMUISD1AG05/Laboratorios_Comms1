...
class ModulacionPM_osc(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Modulacion PM_osc")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulacion PM_osc")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModulacionPM_osc")
        ...
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, 'Ganancia transmisor', "counter_slider", float)
...
def main(top_block_cls=ModulacionPM_osc, options=None):
